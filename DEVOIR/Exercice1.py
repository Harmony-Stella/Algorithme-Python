...
while True:
    ...
    print("1 - Trouver la position d'une lettre majuscule dans l'alphabet")
    print("2 - Trouver la fréquence de chaque lettre dans une chaîne de caractères")
    print("3 - Afficher la position des lettres d'une chaîne de caractères dans l'alphabet")
